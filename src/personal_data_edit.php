    ...
    <form action="edit_process.php" method="post">
        <span class="input-form">
            <p>
                ...
                <input type="text" pattern="^[a-zA-Z0-9_]+$" name="user_id" id="user_id"
                    value="<?= $edit_record["user_id"] ?>">※半角英数字とアンダースコアのみです<br />
            </p>
            <p>
            ...
            <p>
                ...
                <input type="radio" name="user_sex" value="1" id="user_sex1"
                    <?php $edit_record["user_sex"] === 1 ? print "checked" : print ""; ?>>男性
                <input type="radio" name="user_sex" value="2" id="user_sex2"
                    <?php $edit_record["user_sex"] === 2 ? print "checked" : print ""; ?>>女性<br />
            </p>
            <p>
                <label for="user_address">住所</label>
                <input type=text name="user_address" id="user_address"
                    value="<?= $edit_record["user_address"] ?>"><br />
            </p>
            <p>
                <label for="user_tel">電話番号</label>
                <input type=text pattern="^[0-9]+$" name="user_tel" id="user_tel"
                    value="<?= $edit_record["user_tel"] ?>">※ハイフンなし数字のみで入力してください<br />
            </p>
            <p>
                <label for="user_mail_address">メールアドレス</label>
                <input type=text pattern="^[a-zA-Z0-9-_\.]+@[a-zA-Z0-9-_\.]+$" name="user_mail_address"
                    id="user_mail_address" value="<?= $edit_record["user_mail_address"] ?>">※example@example<br />
            </p>
            <p>
